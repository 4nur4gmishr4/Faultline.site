  ...
  return (
    <header className="z-50 w-full shrink-0 border-b border-primary/85 bg-background/92 backdrop-blur-xl">
      <div className="flex h-12 w-full items-stretch">
        <Link
          to="/"
          className="flex min-h-11 shrink-0 items-center gap-2 border-r border-primary/85 bg-primary px-5 text-mono-label font-semibold tracking-[0.16em] text-on-primary"
        >
          <VscodeIcon alt={theme === 'dark'} size={16} />
          FAULTLINE
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="ml-auto hidden h-full min-h-11 items-center gap-2 border-l border-primary/85 bg-primary px-6 text-mono-label font-semibold tracking-[0.14em] text-on-primary transition-opacity duration-200 hover:opacity-90 sm:flex sm:ml-0"
        >
          <VscodeIcon alt={theme === 'dark'} size={15} />
          Install
        </a>
      ...
      {open && (
        ...
        >
          ...
          <a
            href={MARKETPLACE_URL}
            className="flex min-h-12 items-center gap-2 bg-primary px-5 py-4 text-mono-label font-semibold tracking-[0.14em] text-on-primary"
            onClick={() => setOpen(false)}
          >
            <VscodeIcon alt={theme === 'dark'} size={16} />
            Install
